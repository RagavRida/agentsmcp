...
const fallbackCapabilityMatrix: ProductCapabilityMatrix = {
  ...
  capabilities: [
    ...
    { id: "ai-chat-grounding", title: "Grounded AI chat", status: "prototype", category: "ai", summary: "The UI supports knowledge chat and graph search, but answer citation and refusal policies need full product enforcement.", evidence: ["ui/src/App.tsx", "src/eval/grounding.ts", "src/model/provider.ts"], nextMilestone: "Require source evidence on every generated answer and expose no-grounding states in the UI." },
